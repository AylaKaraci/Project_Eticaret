...
namespace Project_Eticaret.SERVICE.Base
{
    public class BaseService<T> : ICoreService<T> where T : CoreEntity
    {
        ...
        {
            item.Status = Status.Deleted; // veriyi db den silmiyoruz sadece statusü güncelliyoruz.
            Update(item);
        }
        ...
        //Singleton Patern tarafı ile iligili cache sorunuun engellemek için DetachEntity() metodu mutlaka yazılmalıdır.
